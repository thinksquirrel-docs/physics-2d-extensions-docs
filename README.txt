...
Joint math is from the open-source Box2D project (the same physics engine used as a base for Unity's 2D physics system):
http://box2d.org/

Controller math is from the open-source Farseer Physics library (based on Box2D):
http://farseerphysics.codeplex.com/

Editor scripts use the DotNetZip library:
